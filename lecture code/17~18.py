...
class Account:
    ...
    def deposit(self, amount):
        """Add amoount to balance"""
        self.balance = self.balance + amount
        return self.balance

    def withdraw(self, amount):
        """Subtract amount from balance if funds are availabel."""
        if amount > self.balance:
            return "Indufficent funds."
        self.balance = self.balance - amount
        return self.balance
...
class CheckingAccount(Account):
    ...
    def withdraw(self, amount):
        ...
        ## 或者使用 super()
        return super().withdraw(amount, self.withdraw_free)
...
class SavingsAccount(Account):
    ...
    deposit_free = 2
    def deposit(self, amount):
        return Account.deposit(self, amount - self.deposit_free)
